      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
          ...
          <p className="text-gray-600 mb-4">
            Practice your startup elevator pitch to investors.
          </p>

          <button
            onClick={() => navigate('/practice/startup')}
        ...
        <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
          ...
          <p className="text-gray-600 mb-4">
            Present your product features to potential customers.
          </p>

          <button
            onClick={() => navigate('/practice/product-demo')}
            className="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700"
          >
            Start Practice
          </button>
        ...
        <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
          ...
          <p className="text-gray-600 mb-4">
            Practice closing investment rounds with confidence.
          </p>

          <button
            onClick={() => navigate('/practice/fundraising')}
            className="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700"
          >
            Start Practice
          </button>
