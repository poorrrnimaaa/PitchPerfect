    ...
    <header className={`site-header ${isMarketing ? 'site-header--marketing' : ''}`}>
      <div className="container header-inner">
        ...
        <div className="header-actions">
          ...
          {isMarketing && <button className="icon-button mobile-menu-button" onClick={() => setMenuOpen(!menuOpen)} aria-expanded={menuOpen} aria-label="Toggle navigation"><Icon name={menuOpen ? 'close' : 'bars'} /></button>}
        </div>
      </div>
